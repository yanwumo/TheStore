                ...
                <div class="col-md-4">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            ...
                            <p>&nbsp;</p>
                            <p><a class="btn btn-primary" href="view_facebook_item.php?id=<?php echo $row["id"]; ?>">查看詳情</a></p>
                        </div>
                    </div>
                </div>
                <?php
    ...
    <div class="col-md-2">
        ...
        <?php } else { ?>
            <form role="form" action="post_login.php" method="post">
                ...
                <button type="button" onclick="window.location.href='register.php'" class="btn btn-default">註冊</button>
            </form>
        <?php } ?>
    </div>
